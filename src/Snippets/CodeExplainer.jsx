...
const CodeExplainer = () => {
  ...
  const FetchChart = async () => {
    ...
    try {
      ...
      const res = await axios.post("https://cbackend-1.onrender.com/ai/get-response" , 
  ...
  const AddToFavourite = async () => {
    try {
      const res = await axios.post("https://cbackend-1.onrender.com/user/addfavourite" , {code : code , response : response} , {withCredentials : true}) ; 
